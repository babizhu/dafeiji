...
public class WingExpTemplet{
    ...
    public WingExpTemplet( Element element ){
    ...
    public String toString(){
        return "WingExpTemplet [id = " + id + ",lv = " + lv + ",expUp1 = " + expUp1 + ",expUp2 = " + expUp2 + ",expUp3 = " + expUp3 + ",expUp4 = " + expUp4 + ",expUp5 = " + expUp5 + ",expUp6 = " + expUp6 + ",expUp7 = " + expUp7 + ",expUp8 = " + expUp8 + ",expUp9 = " + expUp9 + ",expUp10 = " + expUp10 + ",expUp11 = " + expUp11 + ",expUp12 = " + expUp12 + ",expPh1 = " + expPh1 + ",expPh2 = " + expPh2 + ",expPh3 = " + expPh3 + ",expPh4 = " + expPh4 + ",expPh5 = " + expPh5 + ",expPh6 = " + expPh6 + ",expPh7 = " + expPh7 + ",expPh8 = " + expPh8 + ",expPh9 = " + expPh9 + ",expPh10 = " + expPh10 + ",expPh11 = " + expPh11 + ",expPh12 = " + expPh12 + "]";
    }
