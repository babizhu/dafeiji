...
public class StuffTemplet{
    ...
    public String toString(){
        return "StuffTemplet [id = " + id + ",name = " + name + ",order = " + order + ",type = " + type + ",quality = " + quality + ",purpose = " + purpose + ",source = " + source + ",addUp = " + addUp + ",sellPrice = " + sellPrice + ",sellPriceDs = " + sellPriceDs + ",resId = " + resId + ",describe = " + describe + "]";
    }
