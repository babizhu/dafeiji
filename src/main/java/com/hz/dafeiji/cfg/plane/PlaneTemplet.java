...
public class PlaneTemplet{
    ...
    public String toString(){
        return "PlaneTemplet [id = " + id + ",name = " + name + ",quality = " + quality + ",currentLv = " + currentLv + ",hp = " + hp + ",attack = " + attack + ",aspd = " + aspd + ",hpUp = " + hpUp + ",attackUp = " + attackUp + ",skill1 = " + skill1 + ",skill2 = " + skill2 + ",price = " + price + ",describe = " + describe + "]";
    }
