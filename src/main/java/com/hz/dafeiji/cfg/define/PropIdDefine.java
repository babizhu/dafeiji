...
public static int ZH_JING_YAN_KA_5 = 533008;/** 进阶卡 **/
public static int SL_JIN_JIE_KA = 534000;/** 僚机万能碎片 **/
public static int SL_WAN_NENG_LIAO_JI = 534001;/** 巡洋舰碎片 **/
public static int SL_XUN_YANG_ZHAN_JIAN = 534002;/** 白鲸战艇碎片 **/
public static int SL_BAI_JING_ZHAN_JIAN = 534003;/** 进阶图纸 **/
public static int SZ_JIN_JIE_TU_ZHI = 535000;/** 万能碎片 **/
public static int SZ_WAN_NENG_ZHUANG_BEI = 535001;/** 通用舰炮I型碎片 **/
public static int SZ_TONG_YONG_PAO_JIAN = 535002;/** 电鳗主力舰炮碎片 **/
public static int SZ_DIAN_MAN_ZHU_LI = 535003;/** I式改碎片 **/
public static int SZ_GAI_SUI_PIAN = 535004;/** I式能量回收箱碎片 **/
public static int SZ_NENG_LIANG_HUI_SHOU = 535005;/** 电鳗聚能底座碎片 **/
public static int SZ_DIAN_MAN_JU_NENG = 535006;/** 电鳗回能箱碎片 **/
public static int SZ_DIAN_MAN_HUI_NENG = 535007;/** 以太装甲碎片 **/
public static int SZ_YI_TAI_ZHUANG_JIA = 535008;/** 源质装甲碎片 **/
public static int SZ_ZI_YUAN_ZHUANG_JIA = 535009;/** 泰坦装甲碎片 **/
public static int SZ_TAI_TAN_ZHUANG_JIA = 535010;/** 伊冷星水晶炮碎片 **/
public static int SZ_YI_LENG_XING = 535011;/** 星云风暴碎片 **/
public static int SZ_XING_YUN_FENG_BAO = 535012;/** 水晶充能阀碎片 **/
public static int SZ_SHUI_JING_CHONG_NENG = 535013;/** 水晶延时轮组碎片 **/
public static int SZ_SHUI_JING_YAN_SHI = 535014;/** 水平星仪碎片 **/
public static int SZ_SHUI_PING_XING_YI = 535015;/** 星云转化仪碎片 **/
public static int SZ_XING_YUN_ZHUAN_HUA = 535016;/** 伊冷星水晶装甲碎片 **/
public static int SZ_YI_LENG_SHUI_JING = 535017;/** 星云装甲碎片 **/
public static int SZ_XING_YUN_ZHUANG_JIA = 535018;
		public static void reload() {
		DefineTempletCfg.init();
CASH_JIN_BI = getInt("CASH_JIN_BI");CASH_ZUAN_SHI = getInt("CASH_ZUAN_SHI");ZONG_JI_FEN = getInt("ZONG_JI_FEN");ZHOU_JI_FEN = getInt("ZHOU_JI_FEN");HUO_DONG_JI_FEN = getInt("HUO_DONG_JI_FEN");ZHAN_DOU_LI = getInt("ZHAN_DOU_LI");XING_DONG_LI = getInt("XING_DONG_LI");JU_LI = getInt("JU_LI");NENG_YUAN = getInt("NENG_YUAN");JING_YAN = getInt("JING_YAN");ZQ_TIAN_SHEN_ZHU_FU = getInt("ZQ_TIAN_SHEN_ZHU_FU");ZQ_TIAO_GUAN_DAO_JU = getInt("ZQ_TIAO_GUAN_DAO_JU");ZQ_HE_DAN = getInt("ZQ_HE_DAN");ZQ_SI_WANG_JIE_LI = getInt("ZQ_SI_WANG_JIE_LI");ZQ_KAI_JU_HU_DUN = getInt("ZQ_KAI_JU_HU_DUN");ZQ_XIN_SHENG_QU_DONG = getInt("ZQ_XIN_SHENG_QU_DONG");ZQ_SI_WANG_QU_DONG = getInt("ZQ_SI_WANG_QU_DONG");ZZ_HUANG_SE_BAO_HU_ZAO = getInt("ZZ_HUANG_SE_BAO_HU_ZAO");ZZ_LAN_SE_BAO_HU_ZAO = getInt("ZZ_LAN_SE_BAO_HU_ZAO");ZZ_KUANG_RE_QU_DONG = getInt("ZZ_KUANG_RE_QU_DONG");ZZ_AI_XIN = getInt("ZZ_AI_XIN");ZZ_PU_TONG_ZI_DAN = getInt("ZZ_PU_TONG_ZI_DAN");ZZ_KUANG_BAO_ZI_DAN = getInt("ZZ_KUANG_BAO_ZI_DAN");ZZ_CI_TIE = getInt("ZZ_CI_TIE");ZZ_XIAO_SHUI_JING = getInt("ZZ_XIAO_SHUI_JING");ZZ_ZHONG_SHUI_JING = getInt("ZZ_ZHONG_SHUI_JING");ZZ_DA_SHUI_JING = getInt("ZZ_DA_SHUI_JING");ZH_JIN_JIE_KA = getInt("ZH_JIN_JIE_KA");ZH_CHU_JI_NENG_YUAN_BAO = getInt("ZH_CHU_JI_NENG_YUAN_BAO");ZH_GAO_JI_NENG_YUAN_BAO = getInt("ZH_GAO_JI_NENG_YUAN_BAO");ZH_JING_YAN_KA_1 = getInt("ZH_JING_YAN_KA_1");ZH_JING_YAN_KA_2 = getInt("ZH_JING_YAN_KA_2");ZH_JING_YAN_KA_3 = getInt("ZH_JING_YAN_KA_3");ZH_JING_YAN_KA_4 = getInt("ZH_JING_YAN_KA_4");ZH_JING_YAN_KA_5 = getInt("ZH_JING_YAN_KA_5");SL_JIN_JIE_KA = getInt("SL_JIN_JIE_KA");SL_WAN_NENG_LIAO_JI = getInt("SL_WAN_NENG_LIAO_JI");SL_XUN_YANG_ZHAN_JIAN = getInt("SL_XUN_YANG_ZHAN_JIAN");SL_BAI_JING_ZHAN_JIAN = getInt("SL_BAI_JING_ZHAN_JIAN");SZ_JIN_JIE_TU_ZHI = getInt("SZ_JIN_JIE_TU_ZHI");SZ_WAN_NENG_ZHUANG_BEI = getInt("SZ_WAN_NENG_ZHUANG_BEI");SZ_TONG_YONG_PAO_JIAN = getInt("SZ_TONG_YONG_PAO_JIAN");SZ_DIAN_MAN_ZHU_LI = getInt("SZ_DIAN_MAN_ZHU_LI");SZ_GAI_SUI_PIAN = getInt("SZ_GAI_SUI_PIAN");SZ_NENG_LIANG_HUI_SHOU = getInt("SZ_NENG_LIANG_HUI_SHOU");SZ_DIAN_MAN_JU_NENG = getInt("SZ_DIAN_MAN_JU_NENG");SZ_DIAN_MAN_HUI_NENG = getInt("SZ_DIAN_MAN_HUI_NENG");SZ_YI_TAI_ZHUANG_JIA = getInt("SZ_YI_TAI_ZHUANG_JIA");SZ_ZI_YUAN_ZHUANG_JIA = getInt("SZ_ZI_YUAN_ZHUANG_JIA");SZ_TAI_TAN_ZHUANG_JIA = getInt("SZ_TAI_TAN_ZHUANG_JIA");SZ_YI_LENG_XING = getInt("SZ_YI_LENG_XING");SZ_XING_YUN_FENG_BAO = getInt("SZ_XING_YUN_FENG_BAO");SZ_SHUI_JING_CHONG_NENG = getInt("SZ_SHUI_JING_CHONG_NENG");SZ_SHUI_JING_YAN_SHI = getInt("SZ_SHUI_JING_YAN_SHI");SZ_SHUI_PING_XING_YI = getInt("SZ_SHUI_PING_XING_YI");SZ_XING_YUN_ZHUAN_HUA = getInt("SZ_XING_YUN_ZHUAN_HUA");SZ_YI_LENG_SHUI_JING = getInt("SZ_YI_LENG_SHUI_JING");SZ_XING_YUN_ZHUANG_JIA = getInt("SZ_XING_YUN_ZHUANG_JIA");
		}
