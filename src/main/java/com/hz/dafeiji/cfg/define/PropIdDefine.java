...
CASH_JIN_BI = getInt("CASH_JIN_BI");CASH_ZUAN_SHI = getInt("CASH_ZUAN_SHI");ZONG_JI_FEN = getInt("ZONG_JI_FEN");ZHOU_JI_FEN = getInt("ZHOU_JI_FEN");HUO_DONG_JI_FEN = getInt("HUO_DONG_JI_FEN");ZHAN_DOU_LI = getInt("ZHAN_DOU_LI");XING_DONG_LI = getInt("XING_DONG_LI");JU_LI = getInt("JU_LI");NENG_YUAN = getInt("NENG_YUAN");JING_YAN = getInt("JING_YAN");
		}
